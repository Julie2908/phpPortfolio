...
<?php
    $plakater = [
        ["Billede" => "images/FiskenPlakat1-kopi.jpg", "Titel"=> "Fisken", "Farve" => "Hvid og Sort", "Størrelse" => "A4", "Pris" => 129.00],
        ["Billede" => "images/FiskenPlakat1-kopi.jpg", "Titel"=> "Fisken", "Farve" => "Hvid og Sort", "Størrelse" => "A3", "Pris" => 149.00],
        ["Billede" => "images/FiskenPlakat1-kopi.jpg","Titel"=> "Fisken", "Farve" => "Hvid og Sort", "Størrelse" => "A2", "Pris" => 179.00],
        ["Billede" => "images/FiskenPlakat1-kopi.jpg","Titel"=> "Fisken", "Farve" => "Hvid og Sort", "Størrelse" => "A1", "Pris" => 249.00],
...
<h2>Dette er de udvalgte plakater:</h2>
...
<?php foreach ($plakater as $plakat): ?>
    <div class="card card-body text-center m-3" style="width: 18rem;">
        ...
        <div class="card-body">
        <h4 class="card-title" style="font-weight: bold"><?=$plakat["Titel"]?></h4>
